...
function BookJob() {
    ...
    // Helper to block scientific notation (e, E, +, -) in number inputs
    ...
    // Helper to filter numeric characters and symbols from name (only English characters and spaces allowed)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (deliveryDate < pickupDate) {
                setError('Delivery date and time must be after the pickup date and time.');
                setLoading(false);
                return;
            }
                    ...
                    <div className="form-row" style={{ marginTop: '0.75rem' }}>
                        ...
                        <div className="form-group">
                            ...
                            <Flatpickr
                                ...
                                options={{
                                    minDate: formData.pickup.datetime ? new Date(formData.pickup.datetime) : "today",
                                    dateFormat: "Y-m-d H:i",
                                }}
                                placeholder="Select Date & Time"
                            />
