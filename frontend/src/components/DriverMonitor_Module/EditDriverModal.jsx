...
function EditDriverModal({ isOpen, onClose, onDriverUpdated, driver }) {
    ...
    useEffect(() => {
        if (driver && isOpen) {
            setFormData({
                ...
                email: driver.email || '',
                experienceLevel: driver.experienceLevel || 'Junior',
        ...
        <div className="modal-overlay">
            <div className="modal-content" style={{ maxWidth: '600px', width: '90%', padding: '2rem' }}>
                <div className="modal-header" style={{ marginBottom: '1.5rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '1rem' }}>
                    <h2 style={{ fontSize: '1.5rem', color: 'var(--text-primary)', margin: 0 }}>Edit Driver</h2>
